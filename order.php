...
<div class="fix"">
	...
	<img src="cart5.png" style="height:30px;width:30px;"></span>&nbsp;&nbsp;&nbsp;|&nbsp;
		...
		<?php
			...
			echo "<p class='dd-content'><a href='logout.php?id=0' style='text-decoration:none;'>Logout</a></p>";
			}else
			{
...
<?php
//inside cart
$sql1="select * from cart where email='".$_SESSION['email_id']."' and status='o' ORDER BY iid DESC";
$result1=mysqli_query($con,$sql1);

if(mysqli_num_rows($result1)>0)
{
echo "<div style='box-shadow:20px 20px 50px 10px #f1f1f1;border-radius:1px;padding:6px;margin-left:100px'>
		<span style='font-family:arial;color:red;border:1px solid red;border-radius:2px;padding:5px 10px 5px 10px;'>Your Orders</span>	
		</div>";
...
$row2=mysqli_fetch_array($result2);
	...
	echo "<td><br><br><br><br><span style='margin-left:180px;font-family:arial;'>
			";
			if($row1['deliver']=='nd')
				echo "Delivery Status : <span style='color:red;font-size:15px;font-weight:bold;'>Deliver Soon</span>";
			else	
				echo "Delivery Status : <span style='color:green;font-size:15px;font-weight:bold;'>Successfully Delivered</span>";
			echo "</td>
		</tr>";
	echo "</table>";	
	echo "</div><br><br>";
...
echo "<div style='box-shadow:20px 20px 50px 10px #f1f1f1;border-radius:1px;padding:6px;margin-left:100px'>
		<span style='font-family:arial;color:red;border:1px solid red;border-radius:2px;padding:5px 10px 5px 10px;'>No Order Placed</span><br><br>
