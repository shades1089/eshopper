...
<div class="fix"">
	...
	<img src="cart5.png" style="height:30px;width:30px;"></span>&nbsp;&nbsp;&nbsp;|&nbsp;
		...
		<div class="dropdown-content">
			<p class="dd-content" style="border-bottom:1px solid #e9e9e9;"><a href='login.php' style='text-decoration:none;'>Login</a></p>
			<p class="dd-content"><a href='signup.php' style='text-decoration:none;'>SignUp</a></p>
		</div>
	</div>
...
<table align="center" style="font-family:arial;font-size:13px;">
	<tr>
		<td colspan=2 align="center" style="font-weight:bold;font-size:20px;">Login to e-Shopper<br><br></td>
	</tr>	
	<tr>
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="select * from register where email='".$_POST['email']."' and password='".$_POST['pswd']."'";
		...
		if(mysqli_num_rows($result)>0)
		{
			...
			switch($pagename)
				{
				case 'checker.php' : header("Location:cart.php?id=".$id);break;
	...
	<tr>
		...
		<td><input type="email" name="email" placeholder="Email Address" value ="<?php echo $email; ?>" required></td>
	</tr>
	<tr>
		<td>Enter Password </td>
		<td><input type="text" name="pswd" placeholder="Password" value ="<?php echo $pswd; ?>" required></td>
	</tr>
